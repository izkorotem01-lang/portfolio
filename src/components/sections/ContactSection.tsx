...
import { Mail, MessageCircle, Instagram, Youtube, Linkedin, Send } from 'lucide-react';
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
                ...
                {contactMethods.map((method, index) => (
                  ...
                  >
                    <div className="flex items-center space-x-4">
                      <div className={`w-12 h-12 rounded-xl bg-gradient-to-r ${method.color} flex items-center justify-center group-hover:glow`}>
              ...
              {/* Social Links */}
              <div>
                <h3 className="text-xl font-bold mb-4 text-foreground">Follow My Work</h3>
