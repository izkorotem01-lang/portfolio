...
const PackagesSection = () => {
  ...
  return (
    <section id="packages" className="py-20 relative overflow-hidden">
      {/* Background */}
      <div className="absolute inset-0 bg-gradient-to-b from-secondary-dark via-background to-secondary-dark" />
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            {packages.map((pkg, index) => (
              ...
              >
                ...
                <div className="space-y-3 mb-8">
                  {pkg.features.map((feature, featureIndex) => (
                    ...
                    >
                      ...
                      <span className={`text-sm ${feature.included ? 'text-foreground' : 'text-foreground/50'}`}>
                        {t(feature.key)}
                      </span>
                    </div>
                  ))}
                ...
                {/* CTA Button */}
                <Button 
                  className={`w-full ${pkg.popular ? 'btn-hero' : 'btn-glass'}`}
